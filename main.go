...
import (
	...
	"html/template"
	"maidianba-fluctuate/app/jobs"
	_ "maidianba-fluctuate/app/logic"
	_ "maidianba-fluctuate/app/mail"
...
func main() {
	...
	//error := beego.LoadAppConfig("ini", "/app.conf")
	error := beego.LoadAppConfig("ini", "/Users/henrik/Documents/golang/src/maidianba-fluctuate/conf/app.conf")
